...
function [dydt]=dinamica_BCS_falha(t,y,Entradas,P,falha)
% =========================================================================
% Define as entradas 
% =========================================================================
% Frequência
...
dp = H*P.rho(2)*P.g;
Qc = (falha(2)+Entradas(2)).*((P_wh-Entradas(4)).^0.5)*P.k_choke(1);
...
Qr = ((1).*((Entradas(3) - P_BHP).^(0.5))*P.k_resv(1)) + falha(1);
